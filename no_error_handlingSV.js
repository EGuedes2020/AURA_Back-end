...
//----------------------------------------IMPORT DOS MODELOS
const Institution = require('./server/models/institutions')
const Suggestion  = require('./server/models/suggestions');
const Worker = require('./server/models/workers')
const Badge = require('./server/models/badges')
const Energy = require('./server/models/energy_consumption')
const InstitutionBadge = require('./server/models/institution_badges');
...
//6-Listagem de badges das instituições
